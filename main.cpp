...
int main()
{
    ...
    Item DumaPolnocy("Duma Połnocy", 900, "ad", 100, 8, "melee");

    Item ZbrojaWCW("Zbroja Wiedzminskiego Cechu Wilka", 50, "maxhp", 5, 1, "armor");
    ...
    Item UlepszonaZbrojaWCM("Ulepszona Zbroja Wiedzminskiego Cechu Mantikory", 500, "maxhp", 51, 5, "armor");
    Item UlepszonaZbrojaWCK("Ulepszona Zbroja Wiedzminskiego Cechu Kota", 700, "maxhp", 76, 6, "armor");
    Item UlepszonaZbrojaWCW("Ulepszona Zbroja Wiedzminskiego Cechu Wilka", 900, "maxhp", 100, 7, "armor");
    Item ArcymistrzowskaZbrojaWCW("Arcymistrzowska Zbroja Wiedzminskiego Cechu Wilka", 1600, "maxhp", 200, 8, "armor");
    ...
    if (MainMenu.nmenu()==1)
   {
       if (Game.ReadFile(1)==0)
        {
        Menu CharacterChoice(0, "Wybierz klase bohatera:","Szermierz", "Czołg", "Bogacz", "Przecietniak" );
        ...
        if(CharacterChoice.nmenu()==1)//Szermierz
        {
            ...
            cout<<"Twoja głowna zaleta jest fechtunek. Twoje ciosy"<<endl;
            cout<<"sa zawsze bezbłedne. Jednak jak to wiedzmin"<<endl;
            cout<<"groszem nie smierdzisz."<<endl;
        }
        if(CharacterChoice.nmenu()==2)//Czołg
           {
            ...
            cout<<"Podczas proby traw niezwykle rozwineła sie u ciebie"<<endl;
            cout<<"wytrzymałosc na obrazenia. Jednak jak to wiedzmin"<<endl;
            cout<<"groszem nie smierdzisz."<<endl;
           }
        if(CharacterChoice.nmenu()==3)//Bogacz
            ...
            cout<<"Jestes jednym z najbogatszych wiedzminow, jednak nie wskazuja"<<endl;
            cout<<" na to twoje umiejetnosci. Kraza plotki, ze dorobiłes sie na hazardzie"<<endl;
            cout<<"lub innych szemranych interesach."<<endl;
            }
        if(CharacterChoice.nmenu()==4)//Przecietniak
        {
            Player Geralt(30, 30, 30, 250, 0);
            Game.SaveFile(1, 30, 30, 30, 250, 0, 1);
            cout<<"Wybrales Przecietniaka!"<<endl;
            cout<<"Niczym sie nie wyrozniasz."<<endl;
            cout<<"Posiadasz małe oszczednosci."<<endl;
        }
        cout<<endl;cout<<"Wcisnij dowolny klawisz, aby kontynuowac..."<<endl;getch();system("cls");
        cout<<"\"Pozniej mowiono, ";
            Sleep(1000);
            cout<<"ze człowiek ow nadszedł od połnocy, "<<endl;
            Sleep(1000);
            cout<<"od Bramy Powrozniczej. ";
            Sleep(1000);
            cout<<"Nie był stary, ";
            Sleep(1000);
            cout<<"ale włosy miał zupełnie białe. "<<endl;
            Sleep(1000);
            cout<<"Kiedy sciagnał płaszcz okazało sie,";
            Sleep(1000);
             cout<<"ze na pasie za plecami ma miecz.\'"<<endl;
             cout<<"~~Andrzej Sapkowski, Ostatnie zyczenie";
        cout<<endl;cout<<"Wcisnij dowolny klawisz, aby kontynuowac..."<<endl;getch();}system("cls");
       ...
       Game.ChangeCurrentID(Game.ReadFile(7));
        ...
        while (true)
        {
            ...
            {
                cout<<"Straciłes przytomnosc, nieznajomy zaniosł cie do miasta, ale ograbił cie z całych oszczednosci."<<endl;
                Game.ChangeCurrentID(1);
                Geralt.RemoveMoney();
            }
            //BRAMA POŁUGNIOWA
            LevelWithSimpleDialogs BramaPoludniowa(1, "Brama Południowa", "Stoisz przed wielka podniesiana zelazna", "brama. Z boku w kolejce do urzednika stoi", "tłum krzykliwych ludzi.", 2, 0, 0, 0);
            if(Game.ReturnCurrentID()==BramaPoludniowa.ReturnID())
            {
                ...
                BramaPoludniowa.IntroductionToDialog("Jeden ze strazkow dziwnie sie na ciebie patrzy.");
                BramaPoludniowa.WriteDescriptionOfSurroundings("Napisz \"zagadaj-straznik\", aby porozmawiac z straznikiem.");
                Game.LevelEnd=0;
                ...
                BramaPoludniowa.Dialog( text , "straznik", "Co robia tutaj ci ludzie?", "Co to za miasto?", "Znajdzie sie tutaj dla mnie jakies zlecenie?", "Kupcy... chca zapłacic cło za towary", "Brugge, najpiekniejsze miasto pomiedzy Jaruga, Wstazka i Trava.", "Tys pan wiedzmin, podobno Venzlav szuka posła do dziwozon. Znajdziesz go w swoim pałacu.");
            ...
            //Ul. POŁUDNIOWA
            Level Poludniowa1( 2 , "Ul. Południowa 5", "Stoisz na niezbyt szerokiej brudnej", "drodze, ktora rozciaga sie wzdłuz", "muru.", 66, 64, 1, 3);
        ...
        //Poludniowa2
         Level Poludniowa2( 3 , "Ul. Południowa 4", "Stoisz na niezbyt szerokiej brudnej", "drodze, ktora rozciaga sie wzdłuz", "muru.", 0, 2, 0, 4);
        ...
        //Poludniowa3
         Level Poludniowa3( 4 , "Ul. Południowa 3", "Stoisz na niezbyt szerokiej brudnej", "drodze, ktora rozciaga sie wzdłuz", "muru.", 5, 3, 0, 6);
        ...
        //KOWAL 1
        LevelWithShop Kowal1( 5 , "Kowal", "Stoisz koło umiesnionego kowala. Po twojej lewej", "stronie znajduje sie kowadło oraz piec hutniczy,", "a po prawej stoja stojaki z mieczami.", 0, 0, 4, 0, TemerskiMiecz, NilfgardzkiMiecz, Ementaler, SrebrnyMWCKota, WysmienityMieczWCW, 5);
            if(Game.ReturnCurrentID()==Kowal1.ReturnID())
            {
                Kowal1.WriteTitle();
                Kowal1.WriteDirections();
                Kowal1.WriteDescription();
                Kowal1.WriteDescriptionOfSurroundings("Napisz \"sklep\", aby wyswietlic liste przedmiotow do kupna.");
                Kowal1.WriteDescriptionOfSurroundings("Napisz \"kup-(numer przedmiotu z listy)\", aby kupic dany przedmiot.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //Poludniowa4
         Level Poludniowa4( 6 , "Ul. Południowa 2", "Stoisz na niezbyt szerokiej brudnej", "drodze, ktora rozciaga sie wzdłuz", "muru.", 0, 4, 0, 7);
       ...
       //Poludniowa5
         Level Poludniowa5( 7 , "Ul. Południowa 1", "Stoisz na niezbyt szerokiej brudnej", "drodze, ktora rozciaga sie wzdłuz", "muru.", 8, 6, 0, 0);
        ...
        //Lesna1
        Level Lesna1(8, "Ul. Lesna 1", "Stoisz na waskiej drozce. W poblizu ", "płynie strumyk, w ktorym wesoło", "pływaja ryby", 9, 0, 7, 14);
        ...
        //Lesna2
        Level Lesna2(9, "Ul. Lesna 2", "Stoisz na waskiej drozce. W poblizu ", "płynie strumyk, w ktorym wesoło", "pływaja ryby", 10, 0, 8, 0);
        ...
        //Lesna3
        Level Lesna3(10, "Ul. Lesna 3", "Stoisz na waskiej drozce. W poblizu ", "płynie strumyk, w ktorym wesoło", "pływaja ryby", 0, 0, 9, 11);
        ...
        //Lesna4
        Level Lesna4(11, "Ul. Lesna 4", "Stoisz na waskiej drozce. W poblizu ", "płynie strumyk, w ktorym wesoło", "pływaja ryby", 0, 10, 0, 12);
        ...
        //Lesna5
        Level Lesna5(12, "Ul. Lesna 5", "Stoisz na waskiej drozce. W poblizu ", "płynie strumyk, w ktorym wesoło", "pływaja ryby", 0, 11, 13, 20);
        ...
        //Lesna6
        Level Lesna6(13, "Ul. Lesna 6", "Stoisz na waskiej drozce. W poblizu ", "płynie strumyk, w ktorym wesoło", "pływaja ryby", 12, 0, 19, 0);
        ...
        //Lesna7
        Level Lesna7(14, "Ul. Lesna", "Stoisz na waskiej drozce. W poblizu ", "płynie strumyk, w ktorym wesoło", "pływaja ryby", 0, 8, 0, 19);
        ...
        //Las1
        Level Las1(15, "Las", "Stoisz posrodku wielkiego skupiska", "drzew. Przez niektore korony przebijaja sie", "wiazki swiatła.", 0, 19, 17, 0);
        ...
        //Las2;
        Level Las2(16, "Las", "Stoisz posrodku wielkiego skupiska", "drzew. Przez niektore korony przebijaja sie", "wiazki swiatła.", 0, 17, 0, 0);
        ...
        //Las3
        Level Las3(17, "Las", "Stoisz posrodku wielkiego skupiska", "drzew. Przez niektore korony przebijaja sie", "wiazki swiatła.", 15, 18, 0, 16);
        ...
        //Polana1
        Level Polana1(18, "Polana", "Stoisz na wielkiej polanie", "wyscielonej dywanami wysokich traw.", "W oddali widac las.", 19, 0, 0, 17);
        ...
        //Polana2
        Level Polana2(19, "Polana", "Stoisz posrodku wielkiego skupiska", "drzew. Przez niektore korony przebijaja sie", "wiazki swiatła.", 13, 14, 18, 15);
        ...
        //Cmentarna1
        Level Cmentarna1(20, "Ul. Cmentarna", "Stoisz na starej, brudnej drodze. Wiekszosc", "domow wokoło wydaje sie opuszczonych. W oddali ", "słyszysz odgłosy ghuli i wampir ekimmy lub katakana.", 21, 12, 0, 0);
        ...
        //Cmentarna2
        Level Cmentarna2(21, "Ul. Cmentarna", "Stoisz na starej, brudnej drodze. Wiekszosc", "domow wokoło wydaje sie opuszczonych. W oddali ", "słyszysz odgłosy ghuli i wampir ekimmy lub katakana.", 22, 0, 20, 100);
        ...
        //Cmentarna3
        Level Cmentarna3(22, "Ul. Cmentarna", "Stoisz na starej, brudnej drodze. Wiekszosc", "domow wokoło wydaje sie opuszczonych. W oddali ", "słyszysz odgłosy ghuli i wampir ekimmy lub katakana.", 24, 23, 21, 0);
        ...
        //APTEKA1
        LevelWithShop Apteka1( 23 , "Apteka", "Stoisz przed lada, za ktora stoi", "zielarz. Wokoł unosi sie zapach roznorodnych", "zioł. Na połkach leza ususzone zioła.", 0, 0, 0, 22, Bandarz, MalaApteczka, DuzaApteczka, Jaskolka, Nothing, 4);
            if(Game.ReturnCurrentID()==Apteka1.ReturnID())
            {
                Apteka1.WriteTitle();
                Apteka1.WriteDirections();
                Apteka1.WriteDescription();
                Apteka1.WriteDescriptionOfSurroundings("Napisz \"sklep\", aby wyswietlic liste przedmiotow do kupna.");
                Apteka1.WriteDescriptionOfSurroundings("Napisz \"kup-(numer przedmiotu z listy)\", aby kupic dany przedmiot.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //Cmentarna4
        Level Cmentarna4(24, "Ul. Cmentarna", "Stoisz na starej, brudnej drodze. Wiekszosc", "domow wokoło wydaje sie opuszczonych. W oddali ", "słyszysz odgłosy ghuli i wampir ekimmy lub katakana.", 28, 0, 22, 25);
        ...
        //Cmentarna5
        Level Cmentarna5(25, "Ul. Cmentarna", "Stoisz na starej, brudnej drodze. Wiekszosc", "domow wokoło wydaje sie opuszczonych. W oddali ", "słyszysz odgłosy ghuli i wampir ekimmy lub katakana.", 0, 24, 0, 26);
        ...
        //Cmentarna6
        Level Cmentarna6(28, "Ul. Cmentarna", "Stoisz na starej, brudnej drodze. Wiekszosc", "domow wokoło wydaje sie opuszczonych. W oddali ", "słyszysz odgłosy ghuli i wampir ekimmy lub katakana.", 29, 0, 24, 0);
        ...
        //Cmentarna7
        Level Cmentarna7(29, "Ul. Cmentarna", "Stoisz na starej, brudnej drodze. Wiekszosc", "domow wokoło wydaje sie opuszczonych. W oddali ", "słyszysz odgłosy ghuli i wampir ekimmy lub katakana.", 0, 30, 28, 0);
        ...
        //Cmentarz
        Level Cmentarz(26, "Cmentarz", "Stoisz na placu pełnym zamszonych", " grobow. Kilka ghuli rozkopuje mogiłe", "lub je zgnite ludzkie mieso.", 0, 25, 27, 0);
        ...
        //Kaplica
        Level Kaplica(27, "Kaplica", "Stoisz w małej kaplicy. Ławki", " sa połamane. Na ołtarzu ", "lezy porwany obrus.", 26, 0, 0, 0);
        ...
        //Palacowa1
        Level Palacowa1(30, "Ul. Pałacowa 1", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 0, 31, 0, 29);
        ...
        //Palacowa2
        Level Palacowa2(31, "Ul. Pałacowa 2", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 96, 32, 91, 30);
        ...
        //Palacowa3
        Level Palacowa3(32, "Ul. Pałacowa 3", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 0, 33, 0, 31);
        ...
        //Palacowa4
        Level Palacowa4(33, "Ul. Pałacowa 4", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 0, 34, 0, 32);
        ...
        //Palacowa5
        Level Palacowa5(34, "Ul. Pałacowa 5", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 35, 0, 0, 33);
        ...
        //Palacowa6
        Level Palacowa6(35, "Ul. Pałacowa 6", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 36, 0, 34, 0);
        ...
        //Palacowa7
        Level Palacowa7(36, "Ul. Pałacowa 7", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 0, 37, 35, 0);
        ...
        //Palacowa8
        Level Palacowa8(37, "Ul. Pałacowa 8", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 100, 38, 0, 36);
        ...
        //Palacowa9
        Level Palacowa9(38, "Ul. Pałacowa 9", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 0, 39, 90, 37);
        ...
        //Palacowa10
        Level Palacowa10(39, "Ul. Pałacowa 10", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 40, 41, 0, 38);
        ...
        //PŁATNERZ
        LevelWithShop Platnerz1( 40 , "Sklep płatnerski", "Stoisz koło płatnerza wybijajacej ", "własnie zbroje. Na wieszakach leza", "pieknie zdobione pancerze.", 0, 0, 39, 0, NilfgardzkaZbroja, KeadwanskaZbroja, ZbrojaKrolestwPolnocy, UlepszonaZbrojaWCM, ArcymistrzowskaZbrojaWCW, 5);
            if(Game.ReturnCurrentID()==Platnerz1.ReturnID())
            {
                Platnerz1.WriteTitle();
                Platnerz1.WriteDirections();
                Platnerz1.WriteDescription();
                Platnerz1.WriteDescriptionOfSurroundings("Napisz \"sklep\", aby wyswietlic liste przedmiotow do kupna.");
                Platnerz1.WriteDescriptionOfSurroundings("Napisz \"kup-(numer przedmiotu z listy)\", aby kupic dany przedmiot.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //Palacowa11
        Level Palacowa11(41, "Ul. Pałacowa 11 ", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 0, 42, 0, 38);
        if(Game.ReturnCurrentID()==Palacowa11.ReturnID())
         ...
         //Palacowa12
        Level Palacowa12(42, "Ul. Pałacowa 12 ", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 0, 43, 45, 41);
        if(Game.ReturnCurrentID()==Palacowa12.ReturnID())
         ...
         //Palacowa13
        Level Palacowa13(43, "Ul. Pałacowa 13", "Stoisz na szerokiej drodze pokrytej pieknie ", "zdobionymi kamiennymi płytami. Z obydwu", "stron znajduja sie bogate kamienice.", 0, 44, 0, 42);
        if(Game.ReturnCurrentID()==Palacowa13.ReturnID())
         ...
         //Zielona1
        Level Zielona1(44, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 0, 0, 48, 43);
        if(Game.ReturnCurrentID()==Zielona1.ReturnID())
         ...
         //Zielona2
        Level Zielona2(45, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 42, 0, 46, 0);
        ...
        //ZAKAMAREK
        LevelWithSimpleDialogs Zakamarek1(46, "Zakamarek", "Stoisz na ciemnej uliczce. Nie dociera", " tutaj ani jeden promien słonca.", "", 45, 47, 0, 0);
        if(Game.ReturnCurrentID()==Zakamarek1.ReturnID())
            {
                Zakamarek1.WriteTitle();
                Zakamarek1.WriteDirections();
                Zakamarek1.WriteDescription();
                Zakamarek1.IntroductionToDialog("W rogu spi niepełnosprawny zebrak w swoim prowizorycznym schronieniu");
                Zakamarek1.WriteDescriptionOfSurroundings("Napisz \"zagadaj-zebrak\", aby porozmawiac z zebrakiem.");
                 Geralt.Fight("Grupa bandytow", 75, 15, 20);
                Game.LevelEnd=0;
                if (Geralt.isDeath())
                    {
                        Game.ChangeCurrentID(0);
                ...
                Zakamarek1.Dialog(text, "zebrak", "Co tutaj robisz?", "Nie masz co innego do roboty, tylko cały dzien tutaj siedzisz, pasozycie?", "Daj 1$.", "A gdzie indziej mam byc?", "A ty nie masz nic innego do roboty, tylko mi rzyc zawracac", "Dziekuje. Nie wygladasz na tutejszego, wiec opowiem ci pewna legende. Ponoc pod posagiem krola w naszym miescie ukryty jest skarb od krola Foltesta, ale nikt go jeszzcze nie znalazł. Moze ci sie uda.");
         ...
         //Zielona3
        Level Zielona3(47, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 0, 49, 0, 46);
        ...
        //Zielona4
        Level Zielona4(48, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 44, 105, 49, 0);
        ...
        //Zielona5
        Level Zielona5(49, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 48, 0, 50, 47);
        ...
        //Zielona6
        Level Zielona6(50, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 49, 51, 52, 0);
        ...
        //APTEKA
         LevelWithShop Apteka2( 51 , "Apteka", "Stoisz przed lada, za ktora stoi", "zielarz. Wokoł unosi sie zapach roznorodnych", "zioł. Na połkach leza ususzone zioła.", 0, 0, 0, 50, Bandarz, MalaApteczka, DuzaApteczka, Jaskolka, Nothing, 4);
            if(Game.ReturnCurrentID()==Apteka2.ReturnID())
            {
                Apteka2.WriteTitle();
                Apteka2.WriteDirections();
                Apteka2.WriteDescription();
                Apteka2.WriteDescriptionOfSurroundings("Napisz \"sklep\", aby wyswietlic liste przedmiotow do kupna.");
                Apteka2.WriteDescriptionOfSurroundings("Napisz \"kup-(numer przedmiotu z listy)\", aby kupic dany przedmiot.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //Zielona7
        Level Zielona7(52, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 50, 0, 53, 0);
        ...
        //Zielona8
        Level Zielona8(53, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 52, 54, 56, 0);
        ...
        //WYRWA W MURZE
        Level Wyrwa(54, "Wyrwa w murze", "Czołgasz sie pod mała wyrwa w murze. ", "Z sufitu pomału saczy sie woda.", "W oddali słyszysz dziwne, przytłumione dzwieki", 0, 55, 0, 53);
        ...
        //JASKINIA
    Level Jaskinia1(55, "Jaskinia", "Stoisz w ciemnej grocie. Z podłogi ", "i sufitu wyłaniaja sie stalaktyty,", "stalagmity, i stalagnaty.", 0, 0, 0, 54);
        if(Game.ReturnCurrentID()==Jaskinia1.ReturnID())
            {
                Jaskinia1.WriteTitle();
                Jaskinia1.WriteDirections();
                Jaskinia1.WriteDescription();
                Jaskinia1.WriteNotice("W gruzach widzisz połyskujace cos, na kształt skrzyni.");
                Jaskinia1.WriteDescriptionOfSurroundings("Napisz podnies, aby to wziac.");
               Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //Zielona9
        Level Zielona9(56, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 53, 0, 57, 73);
        ...
        //Zielona10
        Level Zielona10(57, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 56, 106, 58, 104);
        ...
        //Zielona11
        Level Zielona11(58, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 57, 0, 59, 93);
        ...
        //Zielona12
        Level Zielona12(59, "Ul. Zielona", "Stoisz na zadbanej ulicy. Z obu stron otaczaja cie zakłady ", "i kamienice mieszczan, rzemieslnikow. Dzieci bawia sie", "prymitywnymi zabawkami z drewna, biegaja i graja w gry.", 58, 0, 60, 95);
        ...
        //Poludniowa6
        Level Poludniowa6(60, "Ul. Poludniowa 10",  "Stoisz na niezbyt szerokiej brudnej", "drodze, ktora rozciaga sie wzdłuz", "muru.", 59, 0, 0, 61);
        ...
        //Poludniowa7
        Level Poludniowa7(61, "Ul. Poludniowa 9",  "Stoisz na niezbyt szerokiej brudnej", "drodze, ktora rozciaga sie wzdłuz", "muru.", 95, 60, 0, 62);
        if(Game.ReturnCurrentID()==Poludniowa7.ReturnID())
            {
                ...
                Poludniowa7.WriteNotice("Koło kraweznika cos sie dziwnie błyszczy");
                Poludniowa7.WriteDescriptionOfSurroundings("Napisz podnies, aby to wziac.");
               Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //Poludniowa8
        Level Poludniowa8(62, "Ul. Poludniowa 8",  "Stoisz na niezbyt szerokiej brudnej", "drodze, ktora rozciaga sie wzdłuz", "muru.", 94, 61, 0, 63);
        ...
        //Poludniowa9
        Level Poludniowa9(63, "Ul. Poludniowa 7",  "Stoisz na niezbyt szerokiej brudnej", "drodze, ktora rozciaga sie wzdłuz", "muru.", 0, 62, 0, 64);
        ...
        //Poludniowa10
        Level Poludniowa10(64, "Ul. Poludniowa 6",  "Stoisz na niezbyt szerokiej brudnej", "drodze, ktora rozciaga sie wzdłuz", "muru.", 65, 63, 0, 2);
        ...
        // Oboz;
        Level Oboz(65, "Oboz treningowy", "Stoisz na placu, koło duzego", "namiotu. Wokoł ciebie zołnierze cwicza", "fechtunek, strzelanie z łuku.", 0, 0, 64, 66);
        ...
        //Centralna1
        Level Centralna1(66, "Ul. Centralna 1",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 67, 65, 2, 0);
        ...
        //Centralna2
        Level Centralna2(67, "Ul. Centralna 2",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 68, 0, 66, 0);
        ...
        //Centralna3
        Level Centralna3(68, "Ul. Centralna 3",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 69, 102, 67, 0);
       ...
       //Rynek1
         Level Rynek1(69, "Rynek 1",  "Stoisz na zatłoczonym placu pokrytym", "małej wielkosci, kamiennymi płytami. Wokol", "ciebie rozstawione sa stragany.", 77, 70, 68, 78);
        ...
        //Rynek2
         Level Rynek2(70, "Rynek 2",  "Stoisz na zatłoczonym placu pokrytym", "małej wielkosci, kamiennymi płytami. Wokol", "ciebie rozstawione sa stragany.", 74, 71, 102, 69);
        if(Game.ReturnCurrentID()==Rynek2.ReturnID())
         ...
         //Centralna4
        Level Centralna4(71, "Ul. Centralna 4",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 0, 72, 0, 70);
        if(Game.ReturnCurrentID()==Centralna4.ReturnID())
         ...
         //Centralna5
        Level Centralna5(72, "Ul. Centralna 5",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 0, 73, 0, 71);
        if(Game.ReturnCurrentID()==Centralna5.ReturnID())
         ...
         //Centralna6
        Level Centralna6(73, "Ul. Centralna 6",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 0, 56, 104, 72);
        ...
        //Rynek3
         Level Rynek3(74, "Rynek 3",  "Stoisz na zatłoczonym placu pokrytym", "małej wielkosci, kamiennymi płytami. Wokol", "ciebie rozstawione sa stragany.", 75, 0, 70, 77);
        ...
        //Rynek4
         Level Rynek4(75, "Rynek 4",  "Stoisz na zatłoczonym placu pokrytym", "małej wielkosci, kamiennymi płytami. Wokol", "ciebie rozstawione sa stragany.", 0, 76, 74, 87);
        ...
        //Platnerz
        LevelWithShop Platnerz2( 76 , "Sklep płatnerski", "Stoisz koło płatnerza wybijajacej ", "własnie zbroje. Na wieszakach leza", "pieknie zdobione pancerze.", 0, 0, 0, 75, NilfgardzkaZbroja, KeadwanskaZbroja, ZbrojaKrolestwPolnocy, UlepszonaZbrojaWCM, UlepszonaZbrojaWCW, 5);
            if(Game.ReturnCurrentID()==Platnerz2.ReturnID())
            {
                Platnerz2.WriteTitle();
                Platnerz2.WriteDirections();
                Platnerz2.WriteDescription();
                Platnerz2.WriteDescriptionOfSurroundings("Napisz \"sklep\", aby wyswietlic liste przedmiotow do kupna.");
                Platnerz2.WriteDescriptionOfSurroundings("Napisz \"kup-(numer przedmiotu z listy)\", aby kupic dany przedmiot.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //Fontanna
        Level Fontanna(77, "Fontanna",  "Stoisz przed wielka-9 metrowa fontanna", "z bogato zdobionymi rzezbiami po bokach", "i wielkim posagiem na srodku.", 87, 74, 69, 81);
        if(Game.ReturnCurrentID()==Fontanna.ReturnID())
            {
                Fontanna.WriteTitle();
                Fontanna.WriteDirections();
                Fontanna.WriteDescription();
                Fontanna.WriteNotice("W wodzie cos dziwnie błyszczy");
                Fontanna.WriteDescriptionOfSurroundings("Napisz podnies, aby to wziac.");
               Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //Rynek5
         Level Rynek5(78, "Rynek 8",  "Stoisz na zatłoczonym placu pokrytym", "małej wielkosci, kamiennymi płytami. Wokol", "ciebie rozstawione sa stragany.", 81, 69, 0, 79);
        ...
        //APTEKA
         LevelWithShop Apteka3( 79 , "Apteka", "Stoisz przed lada, za ktora stoi", "zielarz. Wokoł unosi sie zapach roznorodnych", "zioł. Na połkach leza ususzone zioła.", 80, 78, 0, 0, Bandarz, MalaApteczka, DuzaApteczka, Jaskolka, Nothing, 4);
            if(Game.ReturnCurrentID()==Apteka3.ReturnID())
            {
                Apteka3.WriteTitle();
                Apteka3.WriteDirections();
                Apteka3.WriteDescription();
                Apteka3.WriteDescriptionOfSurroundings("Napisz \"sklep\", aby wyswietlic liste przedmiotow do kupna.");
                Apteka3.WriteDescriptionOfSurroundings("Napisz \"kup-(numer przedmiotu z listy)\", aby kupic dany przedmiot.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //KOWAL
            LevelWithShop Kowal2( 80 , "Kowal", "Stoisz koło umiesnionego kowala. Po twojej lewej", "stronie znajduje sie kowadło oraz piec hutniczy,", "a po prawej stoja stojaki z mieczami.", 83, 81, 79, 0, TemerskiMiecz, NilfgardzkiMiecz, Ementaler, SrebrnyMWCKota, Zerwikaptur, 5);
            if(Game.ReturnCurrentID()==Kowal2.ReturnID())
            {
                Kowal2.WriteTitle();
                Kowal2.WriteDirections();
                Kowal2.WriteDescription();
                Kowal2.WriteDescriptionOfSurroundings("Napisz \"sklep\", aby wyswietlic liste przedmiotow do kupna.");
                Kowal2.WriteDescriptionOfSurroundings("Napisz \"kup-(numer przedmiotu z listy)\", aby kupic dany przedmiot.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //Rynek6
         Level Rynek6(81, "Rynek 7",  "Stoisz na zatłoczonym placu pokrytym", "małej wielkosci, kamiennymi płytami. Wokol", "ciebie rozstawione sa stragany.", 82, 77, 78, 80);
        ...
        //Rynek7
         Level Rynek7(82, "Rynek 6",  "Stoisz na zatłoczonym placu pokrytym", "małej wielkosci, kamiennymi płytami. Wokol", "ciebie rozstawione sa stragany.", 0, 87, 81, 83);
        if(Game.ReturnCurrentID()==Rynek7.ReturnID())
         ...
         //Centralna7
        Level Centralna7(83, "Ul. Centralna 7",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 0, 82, 80, 84);
        if(Game.ReturnCurrentID()==Centralna7.ReturnID())
         ...
         //Centralna8
        Level Centralna8(84, "Ul. Centralna 8",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 0, 83, 0, 85);
        if(Game.ReturnCurrentID()==Centralna8.ReturnID())
         ...
         //Centralna9
        Level Centralna9(85, "Ul. Centralna 9",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 0, 84, 86, 0);
        ...
        //ZAKAMAREK
        LevelWithSimpleDialogs Zakamarek2(86, "Zakamarek", "Stoisz na ciemnej uliczce. Nie dociera", " tutaj ani jeden promien słonca.", "", 85, 0, 0, 0);
        if(Game.ReturnCurrentID()==Zakamarek2.ReturnID())
            {
                Zakamarek2.WriteTitle();
                Zakamarek2.WriteDirections();
                Zakamarek2.WriteDescription();
                Zakamarek2.IntroductionToDialog("W rogu spi niepełnosprawny zebrak w swoim prowizorycznym schronieniu");
                Zakamarek2.WriteDescriptionOfSurroundings("Napisz \"zagadaj-zebrak\", aby porozmawiac z zebrakiem.");
                 Geralt.Fight("Grupa bandytow", 75, 45, 20);
                Game.LevelEnd=0;
                if (Geralt.isDeath())
                    {
                        Game.ChangeCurrentID(0);
                ...
                Zakamarek2.Dialog(text, "zebrak", "Co tutaj robisz?", "Nie masz co innego do roboty, tylko cały dzien tutaj siedzisz, pasozycie?", "Daj 1$", "A gdzie indziej mam byc?", "A ty nie masz nic innego do roboty, tylko mi rzyc zawracac", "Dziekuje. Nie wygladasz na tutejszego, wiec opowiem ci pewna legende. Ponoc pod posagiem krola w naszym miescie ukryty jest skarb od krola Foltesta, ale nikt go jeszzcze nie znalazł. Moze ci sie uda.");
                if(Zakamarek1.ReturnChosenOption()==3)
                    Geralt.GrabMoney(-1);
        ...
        //Rynek8
         Level Rynek8(87, "Rynek 5",  "Stoisz na zatłoczonym placu pokrytym", "małej wielkosci, kamiennymi płytami. Wokol", "ciebie rozstawione sa stragany.", 88, 75, 77, 82);
        if(Game.ReturnCurrentID()==Rynek8.ReturnID())
         ...
         //Centralna10
        Level Centralna10(88, "Ul. Centralna 10",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 89, 0, 87, 0);
        if(Game.ReturnCurrentID()==Centralna10.ReturnID())
         ...
         //Centralna11
        Level Centralna11(89, "Ul. Centralna 11",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 90, 103, 88, 0);
        if(Game.ReturnCurrentID()==Centralna11.ReturnID())
         ...
         //Centralna12
        Level Centralna12(90, "Ul. Centralna 12",  "Stoisz na szerokiej ulicy, na ktorej", "okoliczni chłopi rozstawili swoje", "stragany. Panuje tu gwar i szum.", 38, 0, 89, 0);
        ...
        //KOWAL
        LevelWithShop Kowal3( 91 , "Kowal", "Stoisz koło umiesnionego kowala. Po twojej lewej", "stronie znajduje sie kowadło oraz piec hutniczy,", "a po prawej stoja stojaki z mieczami.", 31, 0, 0, 0, TemerskiMiecz, NilfgardzkiMiecz, Ementaler, SrebrnyMWCKota, DumaPolnocy, 5);
            if(Game.ReturnCurrentID()==Kowal3.ReturnID())
            {
                Kowal3.WriteTitle();
                Kowal3.WriteDirections();
                Kowal3.WriteDescription();
                Kowal3.WriteDescriptionOfSurroundings("Napisz \"sklep\", aby wyswietlic liste przedmiotow do kupna.");
                Kowal3.WriteDescriptionOfSurroundings("Napisz \"kup-(numer przedmiotu z listy)\", aby kupic dany przedmiot.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
        ...
        //Pomnik Venzlawa
        LevelWithSimpleDialogs PomnikVenzlawa(92, "Pomnik Venzlawa", "Stoisz przed wielkim posagiem krola", "Brugge - Venzlawa. Ubrany jest w płaszcz i korone.", "W reku trzyma berło przypominajace dzwignie.", 0, 93, 94, 0);
        if(Game.ReturnCurrentID()==PomnikVenzlawa.ReturnID())
            {
                ...
                PomnikVenzlawa.IntroductionToDialog("Mezczyzna dziwnie sie na ciebie patrzy.");
                PomnikVenzlawa.WriteDescriptionOfSurroundings("Napisz \"uzyj\" ,aby pociagnac za berło ;) " );
                PomnikVenzlawa.WriteDescriptionOfSurroundings("Napisz \"zagadaj-mezczyzna\", aby porozmawiac z mezczyzna.");
               Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
                ...
                PomnikVenzlawa.Dialog(text, "mezczyzna", "Kto to jest?", "Po co powstał ten pomnik?", "Nie wazne.","Venzlav, krol Brugge, lennik Cintry, potem Temerii.", "Aby upamietnic wojne z Nilfgardem, w ktorej wzieli udział uchodzcy z Cintry.", "Mhmm...");
                if (text=="uzyj")
                {
                    cout<<"Otworzyła sie pod toba zapadnia i spadłes na doł"<<endl;
         ...
         //PlacVenzlawa1
        Level PlacVenzlawa1(93, "Plac Venzlawa",  "Stoisz na placu, na ktorym", "ustawione sa rownolegle ławki", "i rabatki z czerwonymi rozami.", 104, 58, 95, 92);
        if(Game.ReturnCurrentID()==PlacVenzlawa1.ReturnID())
         ...
         //PlacVenzlawa2
        Level PlacVenzlawa2(94, "Plac Venzlawa",  "Stoisz na placu, na ktorym", "ustawione sa rownolegle ławki", "i rabatki z czerwonymi rozami.", 92, 95, 95, 0);
        ...
        //PlacVenzlawa3
        Level PlacVenzlawa3(95, "Plac Venzlawa",  "Stoisz na placu, na ktorym", "ustawione sa rownolegle ławki", "i rabatki z czerwonymi rozami.", 93, 59, 61, 94);
      ...
      //DziedziniecZamek
        Level DziedziniecZamek(96, "Dziedziniec zamku",  "Stoisz na duzym pałacu, na ktorego", "srodku znajduje sie fontanna, a za nia", "schody prowadzace do pałacu.", 98, 0, 31, 0);
      ...
      //SalaTronowa  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!****************************************************!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        Level SalaTronowa(97, "Sala tronowa",  "Stoisz w wielkiej sali pokrytej czerwonym dywanem.", "Wzdłuz drogi do tronu, przed kolumnami stoja stojaki", "ze zbroja wykonana przez najlepszych płatnerzy.", 0, 98, 0, 0);
      ...
      //KorytarzZamek
        Level KorytarzZamek(98, "Korytarz pałacu",  "Stoisz w długim pomieszczeniu. Na tutejszych", "scianach wisza piekne obrazy, a w gablotach", "widnieja rzezby najwspanialszych artystow.", 0, 99, 96, 97);
     ...
     //ZbrojowniaZamek
        Level ZbrojowniaZamek(99, "Zbrojownia",  "Stoisz w pomieszczeniu pełnym zbroji,", "mieczy, łukow, kusz, szbli na wieszakach, podporach", "i stojakach.", 0, 0, 0, 98);
        if(Game.ReturnCurrentID()==ZbrojowniaZamek.ReturnID())
            {
                ...
                ZbrojowniaZamek.WriteNotice("Na wieszaku wisi wiedzminski miecz.");
                ZbrojowniaZamek.WriteDescriptionOfSurroundings("Napisz \"podnies\", aby wziac ten miecz. ");
               Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
    ...
    // OpuszczonyDom1;
        Level OpuszczonyDom1(100, "Opuszczony dom", "Stoisz w pomieszczeniu pełnym pajeczyn", "i starych, okurzonych mebli. W powybijanych", "oknach wisza podarte zasłony.", 0, 21, 0, 0);
        ...
        // NawiedzDom1;
        Level NawiedzonyDom1(101, "Nawiedzony dom", "Stoisz w pomieszczeniu pełnym pajeczyn", "i starych, okurzonych mebli. W powybijanych", "oknach wisza podate zasłony.", 0, 0, 37, 0);
        if(Game.ReturnCurrentID()==NawiedzonyDom1.ReturnID())
         ...
         // WscieklePiesci1
        Level WscieklePiesci1(102, "Ulica", "Obok ciebie stoi tłum ludzi patrzacych", "sie na walczacych piesciarzy.", "Buchmacher zacheca do zakładow.", 70, 0, 0, 68);
        if(Game.ReturnCurrentID()==WscieklePiesci1.ReturnID())
            {
                ...
                WscieklePiesci1.WriteDescriptionOfSurroundings("Napisz \"akceptuj\", aby wziac udział w walce.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
                ...
                if(text=="akceptuj")
                {
                    Geralt.Fight("Piesciarz ", 30, 10, 3);
                    if (Geralt.isDeath())
                    {
                        Game.ChangeCurrentID(0);
                        Game.LevelEnd=1;
        ...
        // WscieklePiesci2
        Level WscieklePiesci2(103, "Ulica", "Obok ciebie stoi tłum ludzi patrzacych", "sie na walczacych piesciarzy.", "Buchmacher zacheca do zakładow.", 0, 0, 0, 89);
        if(Game.ReturnCurrentID()==WscieklePiesci2.ReturnID())
            {
                ...
                WscieklePiesci2.WriteDescriptionOfSurroundings("Napisz \"akceptuj\", aby wziac udział w walce.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
                ...
                if(text=="akceptuj")
                {
                    Geralt.Fight("Piesciarz ", 50, 15, 3);
                    if (Geralt.isDeath())
                    {
                        Game.ChangeCurrentID(0);
                        Game.LevelEnd=1;
        ...
        // WscieklePiesci3
        Level WscieklePiesci3(104, "Ulica", "Obok ciebie stoi tłum ludzi patrzacych", "sie na walczacych piesciarzy.", "Buchmacher zacheca do zakładow.", 73, 57, 93, 0);
        if(Game.ReturnCurrentID()==WscieklePiesci3.ReturnID())
            {
                ...
                WscieklePiesci3.WriteDescriptionOfSurroundings("Napisz \"akceptuj\", aby wziac udział w walce.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
                ...
                if(text=="akceptuj")
                {
                    Geralt.Fight("Piesciarz ", 40, 10, 3);
                    if (Geralt.isDeath())
                    {
                        Game.ChangeCurrentID(0);
                        Game.LevelEnd=1;
        ...
        // WscieklePiesci4
        Level WscieklePiesci4(105, "Ulica", "Obok ciebie stoi tłum ludzi patrzacych", "sie na walczacych piesciarzy.", "Buchmacher zacheca do zakładow.", 0, 0, 0, 48);
        if(Game.ReturnCurrentID()==WscieklePiesci4.ReturnID())
            {
                ...
                WscieklePiesci4.WriteDescriptionOfSurroundings("Napisz \"akceptuj\", aby wziac udział w walce.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
                ...
                if(text=="akceptuj")
                {
                    Geralt.Fight("Piesciarz ", 60, 15, 3);
                    if (Geralt.isDeath())
                    {
                        Game.ChangeCurrentID(0);
                        Game.LevelEnd=1;
            ...
            //PLATNERZ
            LevelWithShop Platnerz3( 106 , "Sklep płatnerski", "Stoisz koło płatnerza wybijajacej ", "własnie zbroje. Na wieszakach leza", "pieknie zdobione pancerze.", 0, 0, 57, 0, NilfgardzkaZbroja, KeadwanskaZbroja, ZbrojaKrolestwPolnocy, UlepszonaZbrojaWCM, UlepszonaZbrojaWCK, 5);
            if(Game.ReturnCurrentID()==Platnerz3.ReturnID())
            {
                Platnerz3.WriteTitle();
                Platnerz3.WriteDirections();
                Platnerz3.WriteDescription();
                Platnerz3.WriteDescriptionOfSurroundings("Napisz \"sklep\", aby wyswietlic liste przedmiotow do kupna.");
                Platnerz3.WriteDescriptionOfSurroundings("Napisz \"kup-(numer przedmiotu z listy)\", aby kupic dany przedmiot.");
                Game.LevelEnd=0;
                while (Game.LevelEnd==0)
                {
                Geralt.DrawHud();
             ...
             //JASKINIA2
    Level Jaskinia2(106, "Jaskinia", "Stoisz w ciemnej grocie. Z podłogi ", "i sufitu wyłaniaja sie stalaktyty,", "stalagmity, i stalagnaty.", 55, 107, 0, 0);
        ...
        //Jaskinia3
    Level Jaskinia3(107, "Jaskinia", "Stoisz w ciemnej grocie. Z podłogi ", "i sufitu wyłaniaja sie stalaktyty,", "stalagmity, i stalagnaty.", 108, 0, 0, 106);
    ...
    //Jaskinia4
    Level Jaskinia4(108, "Jaskinia", "Stoisz w ciemnej grocie. Z podłogi ", "i sufitu wyłaniaja sie stalaktyty,", "stalagmity, i stalagnaty.", 109, 0, 107, 55);
    ...
    //Jaskinia5
    Level Jaskinia5(109, "Jaskinia", "Stoisz w ciemnej grocie. Z podłogi ", "i sufitu wyłaniaja sie stalaktyty,", "stalagmity, i stalagnaty.", 0, 110, 108, 0);
    ...
    //Jaskinia6
    Level Jaskinia6(110, "Jaskinia", "Stoisz w ciemnej grocie. Z podłogi ", "i sufitu wyłaniaja sie stalaktyty,", "stalagmity, i stalagnaty.", 0, 0, 0, 109);
